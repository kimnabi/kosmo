...
<% String ctxPath = request.getContextPath(); %>
  <link href="<%= request.getContextPath()%>/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Menu CSS -->
    <link href="<%= request.getContextPath()%>/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css" rel="stylesheet">
    <!-- toast CSS -->
    <link href="<%= request.getContextPath()%>/plugins/bower_components/toast-master/css/jquery.toast.css" rel="stylesheet">
    <!-- morris CSS -->
    <link href="<%= request.getContextPath()%>/plugins/bower_components/morrisjs/morris.css" rel="stylesheet">
    <!-- animation CSS -->
			...
			<div class="go-gadget-content">
				<div class="gadget_design_wrap left_section">
					<div class="profile">
						<span class="photo">
							<c:choose>
								<c:when test="${not empty sessionScope.loginemp.photo_route}"><img src="<%= ctxPath%>/img/${sessionScope.loginemp.photo_route}" class="emp_photo" title="${sessionScope.loginemp.emp_name}"></c:when>
								<c:otherwise><img src="<%= ctxPath%>/img/photo_profile_small.jpg" class="emp_photo" title="${sessionScope.loginemp.emp_name}"></c:otherwise>
							</c:choose>
						</span>
						<br>
						<span class="info">
					...
					<ul class="type_btn_list_block" id="btn_list_block">
						<li class="odd btn_list_li" style="border-top-left-radius: 5px;">
							<a href="<%= ctxPath%>/jieun/note/write.os" data-bypass="true" data-popup="width=1024,height=790,scrollbars=yes,resizable=yes">
								<span class="type">
									<img src="<%= ctxPath%>/img/030-envelope.png" class="ic_dashboard" />
								</span>
						...
						<li class="even btn_list_li" style="border-top-right-radius: 5px;">
							<a href="<%= ctxPath%>/employee/idv_addressbook.os" data-bypass="true">
								<span class="type">
									<img src="<%= ctxPath%>/img/009-phone book.png" class="ic_dashboard" />
								</span>
						...
						<li class="odd btn_list_li" style="border-bottom-left-radius: 5px;">
							<a href="<%= ctxPath%>/goCalendar.os" data-bypass="true">
								<span class="type">
									<img src="<%= ctxPath%>/img/040-inbox.png" class="ic_dashboard" />
								</span>
						...
						<li class="even btn_list_li" style="border-bottom-right-radius: 5px;">
							<a href="<%= ctxPath%>/boardList.os?fk_dept_no=${sessionScope.loginemp.fk_dept_no}" data-bypass="true">
								<span class="type">
									<img src="<%= ctxPath%>/img/049-check list.png" class="ic_dashboard" />
								</span>
